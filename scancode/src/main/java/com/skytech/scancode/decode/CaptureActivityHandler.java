...
import com.skytech.scancode.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    private Bitmap getBitmapForBundle(Bundle bundle) {
        Bitmap barcode = null;
        if (bundle != null) {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.restart_preview) {
            ...
            state = State.SUCCESS;
            activity.handleDecode((Result) message.obj, getBitmapForBundle(message.getData()));
